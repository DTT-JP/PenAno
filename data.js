...
const DataManager = (() => {
  ...
  function saveToStorage(file) { if (file.json) Storage.saveJson(file.name, file.json); }
  ...
  return { loadFromFileList, loadFromZip, count, index, current, goTo, next, prev, getShapes, addShape, removeShape, updateShape, collectAllLabels, makeRectShape, get files() { return _files; } };
})();
